...
# 1.2) clean build (all)
# 1.3) publishToMavenLocal (copper2go-api/publishing)
# 1.4) Commit and push to master
# 2) Signing
...
# 5) Tag
# 5.1) create tag in idea or git tag v3.2.1-api
# 5.2) git push origin v3.2.1-api -f
