...
public class WorkflowFactoryImplTest {

    final WorkflowFactory workflowFactory = new WorkflowFactoryImpl(Mockito.mock(SyncEngine.class));

    @Example
    void createWorkflowInstanceHello2() {
        final Workflow workflowInstance = workflowFactory.create("Hello", 2, 0);
    ...
    void createWorkflowInstancePricing1() {
        final Workflow workflowInstance = workflowFactory.create("Pricing", 1, 0);
    ...
    void createWorkflowInstanceUndefined() {
        Assertions.assertThatCode(
                () -> workflowFactory.create("Unknown", 0, 0)
