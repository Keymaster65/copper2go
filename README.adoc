...
* [x] Dependabot updates 17.08.2024
* [x] Update to gradle 8.10
* [x] Dependabot updates 13.09.2024
* [x] Dependabot updates 04.10.2024
* [x] Update to gradle 8.10.2
* [x] Dependabot updates 19.10.2024
* [x] Dependabot updates 27.10.2024
* [x] Dependabot updates 16.11.2024
* [x] Dependabot updates 27.02.2025
* [x] Dependabot updates 05.06.2025
* [x] Update to gradle 8.14.2
* [x] More updates 05.06.2025
* [x] Dependabot updates 06.06.2025

=== "Update jackson-databind" and "slf4j-api" Workflow API 3.4.0

* [x] Update jackson-databind from 2.17.1 to 2.19.0
* [x] Update slf4j-api from 2.0.13 to 2.0.17
