...
public class Copper2GoApplicationFactory implements ApplicationFactory {
    ...
    public static Application create(final Config config) {
        return Copper2GoApplicationFactory.create(config, Boolean.parseBoolean(System.getProperty(INCUBATION_VANILLA)));
    }


    @Override
    public Application create() {
        return Copper2GoApplicationFactory.create(config, false);
    }
    static Application create(final Config config, final boolean incubationVanilla) {
